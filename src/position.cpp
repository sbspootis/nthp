...
inline nthp::vectGeneric nthp::generatePixelPosition(nthp::worldPosition pos, nthp::RenderRuleSet* ruleset) {
...
inline nthp::vector<nthp::fixed_t> nthp::generateWorldPosition(nthp::vectGeneric pos, nthp::RenderRuleSet* ruleset) {
