...
namespace script {
        ...
        extern const nthp::script::PtrDescriptor_st nthp_internal_alloc(nthp::script::Script::ScriptDataSet* data, nthp::script::stdVarWidth* target_dsc, nthp::fixed_t size, size_t target, nthp::script::BlockMemoryEntry::bmType type);
